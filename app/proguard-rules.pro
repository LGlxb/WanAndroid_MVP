...
####################上面是MvpArms的混淆规则 下面是自己加的###################
-keep class com.sycode.wandroid.mvp.model.entity.**{ *; }
-keep class com.sycode.wandroid.app.weight.**{ *; }
-keep class com.sycode.wandroid.app.event.**{ *; }
