...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDividerItemDecoration(Context context, int dividerWidth, int firstRowTopMargin,
                                     boolean isNeedSpace, boolean isLastRowNeedSpace) {
        this(context, dividerWidth, firstRowTopMargin, isNeedSpace, isLastRowNeedSpace,
                Color.WHITE);
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        int dividerItemWidth = (maxAllDividerWidth - 2 * spaceWidth) / (spanCount - 1);//item
        // 与item之间的距离
