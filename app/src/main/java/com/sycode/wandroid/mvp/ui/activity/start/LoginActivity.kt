package com.sycode.wandroid.mvp.ui.activity.start
...
import com.sycode.wandroid.app.AppLifecyclesImpl
...
import com.sycode.wandroid.app.utils.afterTextChange
import com.sycode.wandroid.di.component.start.DaggerLoginComponent
import com.sycode.wandroid.di.module.start.LoginModule
import com.sycode.wandroid.mvp.contract.start.LoginContract
import com.sycode.wandroid.mvp.model.entity.UserInfoResponse
import com.sycode.wandroid.mvp.presenter.start.LoginPresenter
...
class LoginActivity : BaseActivity<LoginPresenter>(), LoginContract.View {
    ...
    override fun onSucc(userinfo: UserInfoResponse) {
        ...
        //登陆成功开启保活
        AppLifecyclesImpl().apply { initKeepLive(application) }
    }
