package com.sycode.wandroid.mvp.ui.activity.setting
...
import com.sycode.wandroid.app.weight.IconPreference
...
class GeneralPreferenceFragment : PreferenceFragmentCompat(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("author")?.setOnPreferenceClickListener {
            ShowUtils.showDialog(parentActivity, "扣　扣：330479145\n\n微　信：13113033031\n\n邮　箱：syandroid@sina.cn", "联系我")
            false
        }
        findPreference<Preference>("project")?.setOnPreferenceClickListener {
            val data = BannerResponse("", 0, "", 0, 0, "WanAndroid客户端_仅做学习用途", 0, findPreference<Preference>("project")?.summary.toString())
